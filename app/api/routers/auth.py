...
from app.schemas.business.auth import STokenOut, SLogin, SRegister, SAccessToken
...
async def register_route(user_data: SRegister):
...
async def login_route(response: Response, login_data: SLogin):
...
@router.get("/me")
async def get_me(token_data: UserDepends):

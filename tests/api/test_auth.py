...
async def test__login_rate_limited_returns_429(async_client, monkeypatch):
    import app.services.business.auth as auth_module
    ...
    monkeypatch.setattr(auth_module.CacheService, "try_get", _fake_try_get)
    monkeypatch.setattr(auth_module.CacheService, "try_set", _fake_try_set)
